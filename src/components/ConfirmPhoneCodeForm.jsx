...
import { FormScrollView } from './form';
import WarningSvg from './icons/WarningSvg';
import { Typography } from './typography';
import { OtpInputRowCode } from '../screens/authScreens/signInUP/components/OtpInputRowCode';
...
export function ConfirmPhoneCodeForm({
  phoneNumber = '',
  ...
  useEffect(() => {
    if (isDeleteAccount || !phoneNumber) {
      return undefined;
    }
