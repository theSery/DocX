  ...
  return (
    <AuthScreenLayout
      ...
      <View style={styles.content}>
        <Typography variant="h2" tone="onDark" style={styles.title}>Ընտրեք հաշվի տեսակը`</Typography>
        <Typography variant="h5" tone="onDark" style={styles.subtitle}>Շարունակելու և փաստաթղթերի ստեղծման համար ընտրեք Ձեզ համապատասխանող իրավաբանական կարգավիճակը</Typography>
      </View>
